 ...
 * creation and every call above it is suite-agnostic (D-GEN-9).  The
 * hybrid-only surfaces (gy_pq_pending advancing PENDING -> CONFIRMED, the dual
 * XEdDSA + ML-DSA signed bundle, and a Double Ratchet run crossing an ML-KEM
 * refresh boundary) are exercised inside client.c under this suite.
 */
